...
KPMG_cus_info <- recipe(~., data = KPMG_cus) %>%
...
KPMG_cus_info_address <- KPMG_cus_info %>% left_join(KPMG_address, by = "customer_id") 



KPMG_cus_info_final <- KPMG_cus_info_address %>% left_join(KPMG_trans_cus_saleprice, by = "customer_id") 
